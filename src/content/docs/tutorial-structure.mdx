...
description: "Explore the Background, three main chapters, Challenge Lab, and Final Project."
---
...
**Background → Chapter 1: Coordinate → Chapter 2: Communicate → Chapter 3: Adapt → Challenge Lab → Final Project**
